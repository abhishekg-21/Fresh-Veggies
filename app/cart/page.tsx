...
export default function CartPage() {
  const [cartItems, setCartItems] = useState<CartItem[]>([
    {
      ...
      price: 2.99,
      quantity: 2,
      img: "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?auto=format&fit=crop&w=200&q=60",
      category: "Vegetables",
      inStock: true,
      maxQuantity: 10,
    },
    {
      ...
      price: 1.99,
      quantity: 1,
      img: "https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=200&q=60",
      category: "Vegetables",
      inStock: true,
      maxQuantity: 15,
    },
  ...
  interface CartItem {
    ...
    inStock: boolean;
    maxQuantity: number;
    badge?: string; // 👈 Added optional field
  }
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  ...
                  <svg
                    ...
                    className="w-5 h-5"
                  >
                    <path d="M17.25 12a.75.75 0 0 1-.22.53l-5.25 5.25a.75.75 0 0 1-1.06-1.06L14.44 12 10.72 8.28a.75.75 0 1 1 1.06-1.06l5.25 5.25c.14.14.22.33.22.53z" />
                  </svg>
                </Link>
              </div>
            </div>
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="max-w-7xl mx-auto px-4 py-14">
            {cartItems.length === 0 ? (
              // Empty Cart
              <div className="text-center py-20">
                <div className="inline-flex items-center justify-center bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-full mb-6 border border-green-200">
                ...
                <Link
                  href="/shop"
                  className="inline-block bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold px-8 py-4 rounded-lg shadow-lg transition-all transform hover:scale-105"
                >
                  Start Shopping
                </Link>
              </div>
              ...
              <div className="grid lg:grid-cols-3 gap-10">
                ...
                {/* Right: Summary */}
                <aside className="bg-white border border-gray-100 rounded-2xl shadow-xl p-8 sticky top-28 h-fit">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between text-gray-600">
                      <span>
                        <FiTruck className="inline mr-1 text-green-600" />{" "}
                        Shipping
                      </span>
                      <span>
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 z-10 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <button
                      ...
                      className="bg-green-100 text-green-600 hover:bg-green-600 hover:text-white p-3 rounded-full transition"
